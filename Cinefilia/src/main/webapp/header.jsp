            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form role="form" action="controller?command=EditarUsuarioCommand" method="post">
                        ...
                        <div class="form-group">
                            <label for="dataDeNascimento">Data de Nascimento</label>
                            <input type="text" name="dataDeNascimento" class="form-control" id="dataDeNascimento" pattern="\d{1,2}/\d{1,2}/\d{4}" title="Padṛo dd/MM/YYYY"  value="${sessionScope.usuario.dataDeNascimento}">
                        </div>
